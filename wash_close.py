...
class washClose (pygame.sprite.Sprite):
    def __init__(self, pos):
        super().__init__()
        self.import_character_assets()
        self.frame_index = 0
        self.animation_speed = 0.05
        self.image = self.animations['wash close'][self.frame_index]
        self.rect = self.image.get_rect(topleft=pos)

    def import_character_assets(self):
        character_path = 'C:/Users/Mardyson Justin/Desktop/GameProject/GameProject/assets/water/'
        self.animations = {'wash close': []}
    ...
    def animate(self):
        animation = self.animations['wash close']
